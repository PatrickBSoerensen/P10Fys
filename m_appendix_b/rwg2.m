...
for m=1:TrianglesTotal
    ...
    %Analytical expression for the self-coupling terms
    %See Eibert and Hansen, IEEE Trans. Antennas and Propagation
    %vol. AP-43, No 12, pp. 1499-1502, 1995.
    a=sum(r13.*r13);
    b=sum(r13.*r23);
    c=sum(r23.*r23);
    d=a-2*b+c;
    ...
    Integral(m)=1/6*(1/sqrt(a)*log(N1/D1) +1/sqrt(c)*log(N2/D2) +1/sqrt(d)*log(N3/D3));  
    Integral(m)=4*Integral(m);
