            ...
            for i=1:length(ant.T1)
                ...
                for j=1:length(ant.T1)
                    ...
                    ant.Z(i,j) =...
                        ...
                        (sin(ant.gammaTest(i).*sin(ant.gammaTest(j)).*G2{1,1}(1) ...
                        +cos(ant.gammaTest(i)).*cos(ant.gammaTest(j)).*G1{1,1}(1)) ...
                        -1./k.^2.*ant.T1D(i).*ant.T1D(j).*G1{1,1}(1)...
                        +...
                        ant.T1(i).*ant.T2(j).*...
                        (sin(ant.gammaTest(i)).*sin(ant.gammaTest(j+1)).*G2{1,2}(1) ...
                        +cos(ant.gammaTest(i)).*cos(ant.gammaTest(j+1)).*G1{1,2}(1)) ...
                        -1./k.^2.*ant.T1D(i).*ant.T2D(j).*G1{1,2}(1)...
                        +...
                        ant.T2(i).*ant.T2(j).*...
                        (sin(ant.gammaTest(i+1)).*sin(ant.gammaTest(j+1)).*G2{1,3}(1) ...
                        +cos(ant.gammaTest(i+1)).*cos(ant.gammaTest(j+1)).*G1{1,3}(1)) ...
                        -1./k.^2.*ant.T2D(i).*ant.T2D(j).*G1{1,3}(1)...
                        +...
                        ant.T2(i).*ant.T1(j).*...
                        (sin(ant.gammaTest(i+1)).*sin(ant.gammaTest(j)).*G2{1,4}(1) ...
                        +cos(ant.gammaTest(i+1)).*cos(ant.gammaTest(j)).*G1{1,4}(1)) ...
                        -1./k.^2.*ant.T2D(i).*ant.T1D(j).*G1{1,4}(1));
