    ...
    for h=1:length(faces)
        ...
        for i = 1:3
            ...
            if Nearsum > 0
                ...
                z1Mp = @(q) wp*(1/4*BaseMP(UV(EdgeList(BasisNumberOuter(i),1),:))+1/k^2)*g(UV(EdgeList(BasisNumberOuter(i),1),:),q);
                z2Mp = @(q) wp*(1/4*BaseMP(UV(EdgeList(BasisNumberOuter(i),2),:))+1/k^2)*g(UV(EdgeList(BasisNumberOuter(i),2),:),q);
                z1Mm = @(q) wp*(1/4*BaseMM(UV(EdgeList(BasisNumberOuter(i),1),:))+1/k^2)*g(UV(EdgeList(BasisNumberOuter(i),1),:),q);
                z2Mm = @(q) wp*(1/4*BaseMM(UV(EdgeList(BasisNumberOuter(i),2),:))+1/k^2)*g(UV(EdgeList(BasisNumberOuter(i),2),:),q);
                ...
                z1Np = @(q) wp*(1/4*BaseNP(UV(EdgeList(BasisNumberInner(j),1),:))+1/k^2)*g(UV(EdgeList(BasisNumberInner(j),1),:),q);
                z2Np = @(q) wp*(1/4*BaseNP(UV(EdgeList(BasisNumberInner(j),2),:))+1/k^2)*g(UV(EdgeList(BasisNumberInner(j),2),:),q);
                z1Nm = @(q) wp*(1/4*BaseNM(UV(EdgeList(BasisNumberInner(j),1),:))+1/k^2)*g(UV(EdgeList(BasisNumberInner(j),1),:),q);
                z2Nm = @(q) wp*(1/4*BaseNM(UV(EdgeList(BasisNumberInner(j),2),:))+1/k^2)*g(UV(EdgeList(BasisNumberInner(j),2),:),q);
                ...
                Z(BasisNumberOuter(i), BasisNumberInner(j)) = ...
                        ...
                        * dot(z1Mp(inner(y,:)), z1Np(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z2Np(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z3N(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z4N(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z1Nm(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z2Nm(outer(t,:)))...
                        + dot(z2Mp(inner(y,:)), z1Np(outer(t,:)))...
                        + dot(z2Mp(inner(y,:)), z2Np(outer(t,:)))...
                        + dot(z2Mp(inner(y,:)), z3N(outer(t,:)))...
                        + dot(z2Mp(inner(y,:)), z4N(outer(t,:)))...
                        + dot(z2Mp(inner(y,:)), z1Nm(outer(t,:)))...
                        + dot(z2Mp(inner(y,:)), z2Nm(outer(t,:)))...
                        + dot(z3M(inner(y,:)), z1Np(outer(t,:)))...
                        + dot(z3M(inner(y,:)), z2Np(outer(t,:)))...
                        + dot(z3M(inner(y,:)), z3N(outer(t,:)))...
                        + dot(z3M(inner(y,:)), z4N(outer(t,:)))...
                        + dot(z3M(inner(y,:)), z1Nm(outer(t,:)))...
                        + dot(z3M(inner(y,:)), z2Nm(outer(t,:)))...
                        + dot(z4M(inner(y,:)), z1Np(outer(t,:)))...
                        + dot(z4M(inner(y,:)), z2Np(outer(t,:)))...
                        + dot(z4M(inner(y,:)), z3N(outer(t,:)))...
                        + dot(z4M(inner(y,:)), z4N(outer(t,:)))...
                        + dot(z4M(inner(y,:)), z1Nm(outer(t,:)))...
                        + dot(z4M(inner(y,:)), z2Nm(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z1Np(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z2Np(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z3N(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z4N(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z1Nm(outer(t,:)))...
                        + dot(z1Mp(inner(y,:)), z2Nm(outer(t,:)))...
                        + dot(z2Mm(inner(y,:)), z1Np(outer(t,:)))...
                        + dot(z2Mm(inner(y,:)), z2Np(outer(t,:)))...
                        + dot(z2Mm(inner(y,:)), z3N(outer(t,:)))...
                        + dot(z2Mm(inner(y,:)), z4N(outer(t,:)))...
                        + dot(z2Mm(inner(y,:)), z1Nm(outer(t,:)))...
                        + dot(z2Mm(inner(y,:)), z2Nm(outer(t,:)))...
                        + Z(BasisNumberOuter(i), BasisNumberInner(j));
                    end
                end
                    end
...
%         b(BasisNumberOuter(i)) =...
%             sum(BasisLA(BasisNumberOuter(i),2)/2*wp ...
%             *(BaseMP(UV(EdgeList(BasisNumberOuter(i),1),:))...
%             +BaseMM(UV(EdgeList(BasisNumberOuter(i),1),:))...
%             +BaseMP(UV(EdgeList(BasisNumberOuter(i),2),:))...
%             +BaseMM(UV(EdgeList(BasisNumberOuter(i),2),:))...
%             +BaseMP(UV(EdgeList(BasisNumberOuter(i),3),:))...
%             +BaseMM(UV(EdgeList(BasisNumberOuter(i),4),:)))...
%             *Ei);
        end
    end
end
b = b./2*wp*Ei*(sqrt(b1(:,1).^2+b1(:,2).^2+b1(:,3).^2)...
